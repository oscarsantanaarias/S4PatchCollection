...
static get_current_state_id_t orig_get_current_state_id = (get_current_state_id_t)S4(0x00503770);

typedef void* (__thiscall* get_state_t)(void*, int);
static get_state_t orig_get_state = (get_state_t)S4(0x00503800);

typedef void(__thiscall* set_current_state_t)(void*, void*);
static set_current_state_t orig_set_current_state = (set_current_state_t)S4(0x005036F0);
